...
export function DailyGlucoseChart() {
  return (
    <div className="h-[260px] min-w-0 w-full" role="img" aria-label="Demonstration 24-hour glucose line chart with a target range from 70 to 180 milligrams per deciliter">
      <ResponsiveContainer width="100%" height="100%" minWidth={0}>
        <LineChart data={dailyGlucoseData} margin={{ top: 8, right: 8, left: -20, bottom: 0 }} accessibilityLayer>
